...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2019 at 12:42 PM
...
(91, 'cart', 4, 'user', 0, 3, 2),
(92, 'cart', 12, 'user', 0, 3, 0);
...
(9, '2019-04-21', '2019-04-21', 2, 2, 1, 1),
(10, '2019-04-21', '2019-04-21', 2, 2, 1, 2),
(11, '2019-04-21', '2019-04-21', 2, 2, 1, 11),
(12, '2019-04-22', '2019-04-22', 2, 4, 1, 10);
...
(2, '2019-04-20', '2019-04-21', 1, 2, 2),
(3, '2019-04-20', '2019-04-21', 2, 2, 2),
(4, '2019-04-21', NULL, 0, 2, NULL);
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
...
--
ALTER TABLE `p_include_cart`
  MODIFY `counter` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
