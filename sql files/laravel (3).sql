...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2019 at 07:30 AM
...
(1, 'cart', 2, 'user', 0, 8, 7),
(2, 'cart', 2, 'user', 0, 1, 16),
(3, 'cart', 2, 'user', 0, 7, 4),
(4, 'cart', 2, 'user', 0, 9, 2),
(14, 'cart', 1, 'user', 0, 3, 11),
(15, 'cart', 1, 'user', 0, 2, 10),
(16, 'cart', 1, 'user', 0, 5, 3),
(17, 'cart', 1, 'user', 0, 4, 6),
(20, 'cart', 15, 'user', 0, 4, 3),
(28, 'cart', 15, 'user', 0, 3, 2),
(31, 'cart', 16, 'user', 0, 3, 2),
(36, 'cart', 4, 'user', 0, 3, 1),
(37, 'cart', 12, 'user', 0, 2, 2);
...
--
ALTER TABLE `order_includ_product`
  MODIFY `counter` int(8) NOT NULL AUTO_INCREMENT;
