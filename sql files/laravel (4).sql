...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2019 at 05:15 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `a_order_t` (IN `uid` INT, IN `total` INT, IN `paid` INT, IN `sales_point` VARCHAR(50))  BEGIN
...
(63, 'cart', 12, 'user', 0, 2, 9),
(65, 'cart', 4, 'user', 0, 1, 4),
(66, 'cart', 12, 'user', 0, 1, 3),
(67, 'cart', 4, 'user', 0, 2, 4),
(68, 'cart', 12, 'user', 0, 3, 1);
...
INSERT INTO `order_t` (`order_id`, `order_date`, `payment_method`, `payment_status`, `return_id`, `user_id`, `counter`, `total_amount`, `paid`, `sales_point`) VALUES
(1, '2019-04-16', 'default', '', 0, 14, 12, 0, 11, 'uuu'),
(2, '2019-04-16', 'default', '', 0, 12, 13, 0, 111, '111'),
(3, '2019-04-16', 'default', '', 0, 12, 14, 0, 111, '11'),
(4, '2019-04-16', 'default', '', 0, 12, 15, 0, 11, '111'),
(5, '2019-04-16', 'default', '', 0, 15, 16, 0, 33, '333'),
(6, '2019-04-16', 'default', '', 0, 12, 17, 0, 88, '12'),
(7, '2019-04-16', 'default', '', 0, 12, 18, 0, 10, 'Agrabad'),
(8, '2019-04-16', 'default', '', 0, 12, 19, 0, 10, 'Agrabad'),
(9, '2019-04-16', 'default', '', 0, 12, 20, 0, 10, 'Agrabad'),
(10, '2019-04-16', 'default', '', 0, 12, 21, 0, 10, 'Agrabad'),
(11, '2019-04-16', 'default', '', 0, 14, 22, 0, 11, 'Agrabad'),
(12, '2019-04-16', 'default', '', 0, 14, 23, 0, 12, 'New Delhi'),
(13, '2019-04-16', 'default', '', 0, 14, 24, 0, 12, 'New Delhi'),
(14, '2019-04-16', 'default', '', 0, 12, 25, 0, 12, 'New Delhi'),
(15, '2019-04-16', 'default', '', 0, 12, 26, 0, 12, 'New Delhi');
...
--
ALTER TABLE `order_includ_product`
  MODIFY `counter` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `order_t`
--
ALTER TABLE `order_t`
  MODIFY `counter` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `user`
  MODIFY `u_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
