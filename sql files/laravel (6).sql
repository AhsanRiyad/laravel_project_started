...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2019 at 10:20 AM
...
INSERT INTO `account` (`id`, `user_id`, `total`, `paid`) VALUES
(1, 0, 0, 0);
...
(85, 'cart', 12, 'user', 0, 3, 2),
(86, 'cart', 12, 'user', 0, 8, 2);
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
...
--
ALTER TABLE `order_includ_product`
  MODIFY `counter` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT for table `order_t`
--
ALTER TABLE `order_t`
  MODIFY `counter` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `p_include_cart`
  MODIFY `counter` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
