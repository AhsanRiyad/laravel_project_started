...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2019 at 01:08 PM
...
UPDATE account SET total_tk = total_tk + total , paid_tk = paid_tk + paid where user_id = 0;
...
INSERT INTO `order_t`(`order_id`, `order_date`,   `user_id` , `admin_id` ,  `total_amount` , `paid` , `sales_point`) VALUES (o_no+1 , SYSDATE() ,  uid , admin_id ,total_amount , paid , sales_point );
...
INSERT INTO `account` (`id`, `user_id`, `total_tk`, `paid_tk`) VALUES
(1, 0, 132, 100),
(2, 12, 132, 100);
...
(72, 'cart', 14, 'user', 0, 2, 4),
(77, 'cart', 15, 'user', 0, 2, 1),
(79, 'cart', 14, 'user', 0, 3, 9),
(83, 'cart', 4, 'user', 0, 1, 1),
...
(5, 'hard disk 2TB', 33, 54, 33, 34, 34, 'useful for home', 'hdd', 'western_digital'),
...
(35, '2019-04-19', NULL, 0, 2, NULL),
(36, '2019-04-19', NULL, 0, 2, NULL),
(37, '2019-04-19', NULL, 0, 2, NULL),
(38, '2019-04-19', NULL, 0, 2, NULL),
(39, '2019-04-19', NULL, 0, 2, NULL),
(40, '2019-04-19', NULL, 0, 2, NULL);
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
ALTER TABLE `order_t`
  MODIFY `counter` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `user`
  MODIFY `u_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
