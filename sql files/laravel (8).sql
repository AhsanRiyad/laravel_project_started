...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2019 at 04:17 PM
...
(1, '2019-04-19', NULL, 2, 0, 0, 10),
(2, '2019-04-19', NULL, 2, 0, 0, 10),
(3, '2019-04-19', NULL, 2, 0, 0, 5),
(4, '2019-04-19', NULL, 2, 0, 0, 5);
...
(5, 'hard disk 2TB', 33, 72, 33, 34, 34, 'useful for home', 'hdd', 'western_digital'),
...
--
ALTER TABLE `order_t`
  MODIFY `counter` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
